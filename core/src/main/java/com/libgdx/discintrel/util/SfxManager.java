//WIP(18/06/2026)(Sarthak Mittal)(DegamieSign)(SfxManager)#1,1.1
...
public class SfxManager {
    ...
    musicObejctMap.add(ambience);
    System.out.println(musicObejctMap);
    Sound getClicksnd(Sound clicksnd){return clicksnd;}//Fetching clicksnd in GameApp
