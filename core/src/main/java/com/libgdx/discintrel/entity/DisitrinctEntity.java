...
//    public final Set<KeyCode> activeKeys= new HashSet<>();
   ...
   // public static void setActiveKeys(Set<KeyCode> activeKeys){activeKeys=activeKeys;}
    ...
    public DisitrinctEntity(Group nut, Rectangle finishLine, Text statsDisplay, Group nest, Group squirel, Group stem, Group leafModel, DisitrinctEntity disitrinctEntity, DisitrinctEntity e, int score, double speed, int level) {
        this.nut = nut;
